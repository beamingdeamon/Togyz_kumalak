        ...
        if($opponent_columns_count != 0){
            ...
            for ($i= 1; $i < $opponent_columns_count + 1; $i++) {
                if($i == 1){
                    ...
                    if($i == $opponent_columns_count && $opponent_data['first_column'] % 2 == 0){
                        $user_data['kazan'] = $opponent_data['first_column'];
                    ...
                    if($i == $opponent_columns_count && $opponent_data['second_column'] % 2 == 0){
                        $user_data['kazan'] = $opponent_data['second_column'];
                    ...
                    if($i == $opponent_columns_count && $opponent_data['three_column'] % 2 == 0){
                        $user_data['kazan'] = $opponent_data['three_column'];
                    ...
                    if($i == $opponent_columns_count && $opponent_data['four_column'] % 2 == 0){
                        $user_data['kazan'] = $opponent_data['four_column'];
                    ...
                    if($i == $opponent_columns_count && $opponent_data['five_column'] % 2 == 0){
                        $user_data['kazan'] = $opponent_data['five_column'];
                    ...
                    if($i == $opponent_columns_count && $opponent_data['six_column'] % 2 == 0){
                        $user_data['kazan'] = $opponent_data['six_column'];
                    ...
                    if($i == $opponent_columns_count && $opponent_data['seven_column'] % 2 == 0){
                        $user_data['kazan'] = $opponent_data['seven_column'];
                    ...
                    if($i == $opponent_columns_count && $opponent_data['eight_column'] % 2 == 0){
                        $user_data['kazan'] = $opponent_data['eight_column'];
                    ...
                    if($i == $opponent_columns_count && $opponent_data['nine_column'] % 2 == 0){
                        $user_data['kazan'] = $opponent_data['nine_column'];
